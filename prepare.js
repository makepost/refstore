...
const { outputText, sourceMapText } = transpileModule(
  readFileSync(join(_, "index.js"), "utf8"),
  {
    compilerOptions: { sourceMap: true, target: ScriptTarget.ES5 }
  }
);
writeFileSync(join(_, "index.dist.js"), outputText);
writeFileSync(join(_, "index.dist.js.map"), sourceMapText);
